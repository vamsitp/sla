namespace SLA
{
    ...
    class Program
    {
        ...
        {
            var divider = "-".PadRight(Padding, '-');
            var center = Center(divider);
            var output = new StringBuilder();
            output.AppendLine(divider);
            output.AppendLine("#### `<auto-generated/> README`");
            output.AppendLine(divider);
            output.AppendLine();
            ...
            if (DowntimeExpectations?.Length > 0)
            {
                ...
                output.AppendLine();
                output.AppendLine($"| {"EXPECTED DOWNTIME".PadRight(Padding)} | {"PER / UNIT".PadRight(Padding)} | {"SLA".PadRight(Padding)} |");
                output.AppendLine($"| {Center("-".PadRight(Padding, '-'))} | {center} | {center} |");
            ...
            output.AppendLine($"| {Center("-".PadRight(Padding, '-'))} | {center} | {center} | {center} |");
